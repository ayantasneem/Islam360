...
public class QuranFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View quraninflater = inflater.inflate(R.layout.fragment_quran, container, false);
        btnalquran = (Button) quraninflater.findViewById(R.id.btnAlQuran);

        btnalquran.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent gotoquranview = new Intent(quraninflater.getContext(), QuranActivity.class);
                startActivity(gotoquranview);
            }
        });

        return quraninflater;
    }
}